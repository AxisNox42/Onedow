...
static const AugDef ALL_AUGS[] = {
    ...
    { AugType::CRIT,          AugRarity::RARE,      AugUnique::NONE, "CRIT",
      ...
      { L"10% 확률로 치명타 (피해 ×2.0)  (중첩 시 확률 +20%, 최대 75%)",
        L"10% chance to crit (×2.0 dmg)  (stacks +20%, max 75%)",
        L"10%でクリティカル (×2.0)  (重複で+20%, 最大75%)" } },
    ...
    { AugType::D_SPLITTER,    AugRarity::DEBUFF,    AugUnique::NONE, "D_SPLITTER",
      ...
      { L"일부 프로세스가 웜으로 변이 (처치 시 작은 2마리로 자가복제, 2세대까지) · 처치 EXP +3",
        L"Some processes mutate into worms (self-replicate into 2 on death) · kill EXP +3",
        L"一部プロセスがワームに変異 (撃破で2体に自己複製)・撃破EXP +3" } },
    { AugType::D_BLINKER,     AugRarity::DEBUFF,    AugUnique::NONE, "D_BLINKER",
      { L"트로이목마 침투", L"Trojan Infection", L"トロイ侵入" },
      { L"일부 프로세스가 트로이목마로 변이 (잔상 경고 후 순간이동) · 처치 EXP +6",
        L"Some processes become trojans (teleport toward you after a telegraph) · kill EXP +6",
        L"一部プロセスがトロイに変異 (残像予告後に瞬間移動)・撃破EXP +6" } },
