...
static const AugDef ALL_AUGS[] = {
    // ── 일반 ───────────────────────────────────────────
    { AugType::DMG_UP,        AugRarity::COMMON,    AugUnique::NONE, "DMG+4%",
      { L"공격력 증가", L"Attack Up", L"攻撃力アップ" },
      { L"공격력 +4%  (곱연산 누적)", L"Attack +4%  (multiplicative)", L"攻撃力 +4%  (乗算で累積)" } },
    { AugType::RATE_UP,       AugRarity::COMMON,    AugUnique::NONE, "RATE+1.5%",
      { L"연사 속도 증가", L"Fire Rate Up", L"連射速度アップ" },
      { L"연사 속도 +1.5%", L"Fire rate +1.5%", L"連射速度 +1.5%" } },
    { AugType::SPD_UP,        AugRarity::COMMON,    AugUnique::NONE, "BSPD+10",
      { L"탄속 증가", L"Bullet Speed Up", L"弾速アップ" },
      { L"탄환 속도 +10", L"Bullet speed +10", L"弾速 +10" } },
    { AugType::MOVE_UP,       AugRarity::COMMON,    AugUnique::NONE, "MOVE+2%",
      { L"이동속도 증가", L"Move Speed Up", L"移動速度アップ" },
      { L"이동 속도 +2%", L"Move speed +2%", L"移動速度 +2%" } },
    { AugType::VISION_UP,     AugRarity::COMMON,    AugUnique::NONE, "VISION+50",
      { L"시야 증가", L"Vision Up", L"視界アップ" },
      { L"시야(창 크기) +50  /  최대 4중첩 (+200)",
        L"View (window) +50  /  max 4 stacks (+200)",
        L"視界(ウィンドウ) +50  /  最大4重 (+200)" } },
    { AugType::REGEN_UP,      AugRarity::COMMON,    AugUnique::NONE, "REGEN",
      { L"체력 재생", L"Regeneration", L"体力リジェネ" },
      { L"5초마다 체력 1 추가 회복  (중첩 가능)",
        L"Heal 1 HP every 5s  (stackable)",
        L"5秒ごとに体力1回復  (重複可)" } },
