...
static const AugDef ALL_AUGS[] = {
    ...
    { AugType::LIGHT_AMMO,    AugRarity::RARE,      AugUnique::NONE, "LIGHTAMMO",
      ...
      { L"연사 +10%  /  탄속 +30%  /  공격력 -20%",
        L"Fire rate +10%  /  speed +30%  /  Attack -20%",
        L"連射 +10%  /  弾速 +30%  /  攻撃力 -20%" } },
    ...
    { AugType::CB_WARLORD,     AugRarity::COMBO,    AugUnique::NONE, "CB_WAR",
      ...
      { L"[조합] 공격력 +15% · 1000킬마다 공격력 +5%·연사 +2%·탄속 +2% (최대 10스택)",
        L"[Combo] ATK +15% · per 1000 kills: ATK +5%·rate +2%·spd +2% (max 10)",
        L"[組合] 攻撃+15% · 1000キル毎 攻撃+5%·連射+2%·弾速+2% (最大10)" } },
    ...
    { AugType::D_TROJAN_BOOST, AugRarity::DEBUFF,  AugUnique::NONE, "D_TROJANB",
      ...
      { L"[트로이목마 침투 보유 시] 트로이목마 점멸 재사용시간 단축  (처치 경험치 +2)",
        L"[if you own Trojan Infection] Trojan blink cooldown shortened  (kill XP +2)",
        L"[トロイ侵入所持時] トロイの瞬間移動CD短縮  (撃破経験値+2)" } },
    ...
    { AugType::POPUP_ALLY,     AugRarity::EPIC,     AugUnique::NONE, "POPUP_A",
      { L"popup.exe (아군)", L"popup.exe (ally)", L"popup.exe (味方)" },
      { L"청록 미니 창 1개 — 1.2초마다 자동 사격  (SUMMON · 적 popup 반색)",
        L"Cyan mini window — auto shot every 1.2s  (SUMMON · ally popup)",
        L"シアン小窓 — 1.2秒毎自動射撃  (SUMMON · 味方popup)" } },
