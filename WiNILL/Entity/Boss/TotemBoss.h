...
// ?????????????????????????????????????????????????????????????
// RITE.CORE (TOTEM.sys) ???λ젰 遊됱씤 ?섏떇 蹂댁뒪
//   쨌 4 湲곕뫁???붾㈃ 以묒떖 留??꾨? 怨듭쟾 ???덈? 寃뱀튂吏 ?딅뒗 沅ㅻ룄 諛곗튂
//   쨌 湲곕뫁 ?앹〈 = 蹂댁뒪 臾댁쟻 / Q쨌E쨌R쨌DRAIN쨌SPAWN ?붾쾭??//   쨌 湲곕뫁 ?꾨㈇ ??RITE DOWN(痍⑥빟) ???⑥씠釉?1 ???ъ쓽??//   쨌 蹂댁뒪: ?꾩긽?대룞 쨌 ?뱀씠??蹂댄샇留? 쨌 ?섏텞??쨌 ?뚯쟾 ?덉씠? 쨌 ?섏떇留?湲곕뫁 ?곌껐??
// ?????????????????????????????????????????????????????????????
class TotemBoss {
public:
