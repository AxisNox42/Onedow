...
inline const wchar_t* kTutorialPageBody[LANG_COUNT][TUTORIAL_PAGE_COUNT] = {
    /* KR */
    {
        ...
        L"보스는 VOLLEY.sys, C2_RELAY.sys, FORK.worm, FLAGSHIP.sys 등이 별도 창으로 등장합니다 / "
    ...
    /* EN */
    {
        ...
        L"Bosses like VOLLEY.sys, C2_RELAY.sys, FORK.worm, and FLAGSHIP.sys spawn in their own windows / "
    ...
    /* JP */
    {
        ...
        L"VOLLEY.sys、C2_RELAY.sys、FORK.worm、FLAGSHIP.sys などのボスが別窓で出現 / "
