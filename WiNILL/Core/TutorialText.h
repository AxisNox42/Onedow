...
inline const wchar_t* kTutorialPageBody[LANG_COUNT][TUTORIAL_PAGE_COUNT] = {
    /* KR */
    {
        ...
        L"보스는 VOLLEY.sys, FORK.worm, LAG.exe 가 별도 창으로 등장합니다 / "
    ...
    /* EN */
    {
        ...
        L"Bosses VOLLEY.sys, FORK.worm and LAG.exe spawn in their own windows / "
    ...
    /* JP */
    {
        ...
        L"VOLLEY.sys、FORK.worm、LAG.exe のボスが別窓で出現 / "
